...
import OnlineMallSystem.AdminPackage.Mysql.AdminPasswordMysql;
import OnlineMallSystem.Frame;

import javax.swing.*;

public class AdminPassword extends Frame{
    JFrame frame;
    ...
    public void listener() {
        changeButton.addActionListener(e -> {//修改密码按钮
            ...
            AdminPasswordMysql changePasswordMysql=new AdminPasswordMysql();
            if(!changePasswordMysql.validateAdminPassword(passwordString)){
                ...
                changePasswordMysql.changeAdminPassword(currentPasswordString);
